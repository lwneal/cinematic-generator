...
The Revolution is a documentary film about the American Revolutionary War, covering the events in 1775 leading up to the war, until the signing of the Treaty of Paris in 1783. The film centers on George Washington, Alexander Hamilton, and the Marquis de Lafayette, but includes other characters as well.

This highly awaited history documentary has brought together a cast of A-list Hollywood stars, as well as the best and brightest historians and artists. The gripping story and stunning visuals have led some reviewers to suggest The Revolution may be the greatest documentary film of all time.

We're honored that you've agreed to write the epic, gripping introduction to the film. The introduction consists of {} scenes. You will be working with our concept artist Greg Rutkowski. For each scene, write two sentences: the dialogue to be voice-acted, and a visual art prompt describing the scene that Greg should paint. Please remember: each Visual Art Prompt must stand alone without reference to previous scenes. The introduction covers the events immediately before and leading up to the war.
